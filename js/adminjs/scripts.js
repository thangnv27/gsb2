...
var CustomJS = {
    uploadSingleImage: function($){
        var fields = new Array("favicon", "sitelogo", "topbanner", "bill_header", shortname + "_bgImage");
    ...
    uploadMetaFields: function($){
        var custom_uploader, fields = new Array('slide_img', 'logo_img');
    ...
    sendFeedback:function($){
        $("form#frmFeedback").submit(function(){
            ...
            $("form#frmFeedback input[type='submit']").val("Sending..");
            $.ajax({
                ...
                complete:function(){
                    $("form#frmFeedback input[type='submit']").val("Gửi");
                }
            });
            return false;
        });
...
jQuery(document).ready(function($){
    ...
    $('#' + shortname + '_primaryColor, #' + shortname + '_secondaryColor, #' + shortname + '_bgColor').each(function(){
        var $el = $(this);
        $el.css({
            width: 100,
            height:36,
